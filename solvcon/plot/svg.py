...
class EPath(EShapeBase):
    def __init__(self, d_attr, fill_attr, transform_attr):
        """
...
class ECircle(EShapeBase):
    def __init__(self, cx, cy, r, fill_attr, transform_attr):
        super().__init__(fill_attr, transform_attr)
        self.cx = cx
        self.cy = cy
        self.r = r
...
class EEllipse(EShapeBase):
    def __init__(self, cx, cy, rx, ry, fill_attr, transform_attr):
        super().__init__(fill_attr, transform_attr)
        self.cx = cx
        self.cy = cy
        self.rx = rx
...
class ERectangle(EShapeBase):
    def __init__(self, x, y, width, height, fill_attr, transform_attr):
        super().__init__(fill_attr, transform_attr)
        self.x = x
        self.y = y
        self.width = width
...
class ELine(EShapeBase):
    def __init__(self, x1, y1, x2, y2, fill_attr, transform_attr):
        super().__init__(fill_attr, transform_attr)
        self.x1 = x1
        self.y1 = y1
        self.x2 = x2
...
class EPolyline(EShapeBase):
    def __init__(self, points, fill_attr, transform_attr):
...
class ShapeParser(object):
    ...
    def __init__(self, file_path=None):
        self.file_path = file_path
        self.shapes = {"circle": [], "rect": [], "ellipse": [],
